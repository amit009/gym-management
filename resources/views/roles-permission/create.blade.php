<x-app-layout>    
    <div class="page-title">
        <div class="title_left">
            <h3>{{ __('Create Role and Permissions') }}</h3>
        </div>
        ...
        <div class="col-md-12 col-sm-12 ">
            <div class="x_panel">
                ...
                <div class="x_content">
                    ...
                    @endif
                    <form action="{{route('role.store')}}" method="POST" data-parsley-validate class="form-horizontal form-label-left">
                        @csrf                        
                        <div class="item form-group">
                            <label class="col-form-label col-md-3 col-sm-3 label-align" for="name">Role Name <span class="required">*</span></label>
                            <div class="col-md-6 col-sm-6 ">
                                <input type="text" name="role" class="form-control @error('role')required-field @enderror">
                                    ...
                                    @foreach ($premission as $item)
                                        <div class="col-md-2">
                                            <label class="custom-switch mt-2">
                                                <input type="checkbox" class="js-switch" name="permissions[]" value="{{ $item->name }}" />                                             
                                                {{ $item->name }} 
                                            </label>
