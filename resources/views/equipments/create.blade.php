        ...
        <div class="col-md-12 col-sm-12 ">
            <div class="x_panel">
                ...
                <div class="x_content">
                    ...
                    @endif
                    <form action="{{ route('service.store') }}" method="POST" enctype="multipart/form-data" data-parsley-validate class="form-horizontal form-label-left">
                        @csrf
                        ...
                        <div class="item form-group">
                            ...
                            <div class="col-md-6 col-sm-6 ">
                                <input type="text" name="fee" class="form-control @error('fee')required-field @enderror">
